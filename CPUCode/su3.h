...
} __attribute__((__packed__)) fix24;

typedef struct
{
	fix24 real, imag;
} __attribute__((__packed__)) complex_fix24;

typedef struct
{
	complex_fix24 c00, c01, c02, c10, c11, c12, c20, c21, c22;
} __attribute__((__packed__)) fix_su3;

typedef struct
{
	complex_fix24 s0c0, s1c0, s2c0, s3c0;
	complex_fix24 s0c1, s1c1, s2c1, s3c1;
	complex_fix24 s0c2, s1c2, s2c2, s3c2;
} __attribute__((__packed__)) bqcd_fix_spinor;
